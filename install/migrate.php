    ...
    try {
        ...
        if (!DB::columnExists('users', 'email_verified_at')) {
            if ($isSqlite) {
                ...
                DB::run('ALTER TABLE users ADD COLUMN email_verified_at DATETIME DEFAULT NULL AFTER kyc_verified');
            }
            $lines[] = 'users.email_verified_at column added.';
        }
        ...
        if (!DB::columnExists('users', 'phone_verified_at')) {
            if ($isSqlite) {
                ...
                DB::run('ALTER TABLE users ADD COLUMN phone_verified_at DATETIME DEFAULT NULL AFTER email_verified_at');
            }
            $lines[] = 'users.phone_verified_at column added.';
        }
    } catch (Throwable $e) {
